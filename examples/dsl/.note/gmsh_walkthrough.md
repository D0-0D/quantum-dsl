...
| junction surface | `{component}_{primitive}_jj` | 2 | `tracker.juncs` (后缀 `_jj` 避开与同名 poly/path 体冲突) |
...
physical groups  : 17
  - Q1_jj_jj (dim=2, n_tags=1)            # 命名 = {component}_{primitive}_jj, 这里 primitive 也叫 jj
