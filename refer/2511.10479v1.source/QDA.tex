...
\newcommand\XT[1]{{\color{magenta} [XT: #1]}}
\newcommand{\HZ}[1]{{\textcolor{violet} {[HZ: #1]}}}
\newcommand{\jingzhe}[1]{{\textcolor{violet} {[Jingzhe: #1]}}}
\newcommand{\fang}[1]{{\textcolor{violet} {[Fang: #1]}}}
\newcommand{\wufeng}[1]{{\textcolor{brown} {[WF:#1]}}}
...
\newcolumntype{P}[1]{>{\centering\arraybackslash\small}m{#1}}  
\newcolumntype{L}[1]{>{\arraybackslash\small}m{#1}}           
